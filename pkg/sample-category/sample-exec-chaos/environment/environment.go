...
func GetENV(experimentDetails *experimentTypes.ExperimentDetails) {
	experimentDetails.ExperimentName = types.Getenv("EXPERIMENT_NAME", "chaos")
	...
	experimentDetails.AppNS = types.Getenv("APP_NAMESPACE", "default")
	experimentDetails.AppLabel = types.Getenv("APP_LABEL", "app=nginx")
